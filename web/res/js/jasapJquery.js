...
function parseInput(){
    try {
        ...
        alert('Erro na leit�ra do formul�rio, informe ao suporte do sistema.\n'+err);
        return null;
    }
}
...
function ajaxURL2(url, ji, protectURL, lck){
    ...
    if (url!=null && ji!=null && url!='null' && ((activeIdx<0 && protectURL==1) || protectURL!=1)){
        ...
        //if(lck==1)alert("A requisi��o j� est� em andamento, aguarde!");
    }
}
    ...
    if (json.target=='__PARENT'){
        ...
        if (json.action=='__EVAL'){
            ...
            try {
                ...
                //else alert('Refer�ncia de objeto n�o encontrada ID :'+json.id+', comunique o suporte do sistema.');
            } catch(err) {
